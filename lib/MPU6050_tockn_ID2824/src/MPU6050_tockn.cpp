...
/*
I have modified this library to work with ESP8266 
 - In function calcGyroOffsets() there needs to be a call to yield(),
	else the ESP8266 will go to a soft WDT reset. 
*/
